...
const provider=popoverContentNode.closest('.mud-popover-provider');if(provider&&popoverContentNode.classList.contains(".mud-popover")){const parent=provider.parentElement;if(parent){const overlay=parent.querySelector('.mud-overlay');if(overlay&&!overlay.classList.contains('mud-skip-overlay-positioning')){if(!overlay.style['z-index']){overlay.style['z-index']=popoverContentNode.style['z-index'];}}}}}
